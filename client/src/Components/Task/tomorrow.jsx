...
const Task = () => {
    ...
    useEffect(() => {
        axios.get("http://localhost:3001/tomorrowTask")
    ...
    const submit = (e) => {
        e.preventDefault();
        axios.post("http://localhost:3001/tomorrowTask", { content })
            .then(result => {
                console.log(result);
                navigate('/week');
                toggleSearch();
    ...
    const handleDelete = (taskId) => {
        axios.delete(`http://localhost:3001/tomorrowTask/${taskId}`)
            .then(result => {
                console.log(result);
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" onClick={() => handleDelete(task._id)} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-indigo-600">
