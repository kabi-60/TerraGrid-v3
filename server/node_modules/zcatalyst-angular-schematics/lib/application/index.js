...
function addDependenciesToPackageJson(options) {
    return (host, context) => {
        [
            ...
            {
                type: dependencies_1.NodeDependencyType.Dev,
                name: 'zcatalyst-cli-plugin-angular',
                version: 'latest'
            }
...
function addAppToWorkspaceFile(options, appDir, folderName) {
    ...
    const schematics = {};
    if (options.inlineTemplate || options.inlineStyle || options.minimal || options.style !== schema_1.Style.Css) {
    ...
    if (options.skipTests || options.minimal) {
        const schematicsWithTests = ['class', 'component', 'directive', 'guard', 'interceptor', 'pipe', 'resolver', 'service'];
    ...
    return (0, workspace_1.updateWorkspace)((workspace) => {
        workspace.projects.add(Object.assign({ name: options.name }, project));
    });
}
...
function application(options) {
    return (host) => __awaiter(this, void 0, void 0, function* () {
        ...
        const appDir = options.projectRoot === undefined ? (0, core_1.join)((0, core_1.normalize)(newProjectRoot), folderName) : (0, core_1.normalize)(options.projectRoot);
        const sourceDir = `${appDir}/src/app`;
        return (0, schematics_1.chain)([
            addAppToWorkspaceFile(options, appDir, folderName),
            (0, schematics_1.mergeWith)((0, schematics_1.apply)((0, schematics_1.url)('./files'), [
                options.minimal ? (0, schematics_1.filter)(minimalPathFilter) : (0, schematics_1.noop)(),
                (0, schematics_1.applyTemplates)(Object.assign(Object.assign({ utils: core_1.strings }, options), { relativePathToWorkspaceRoot: (0, paths_1.relativePathToWorkspaceRoot)(appDir), appName: options.name, folderName })),
            ...
            (0, schematics_1.schematic)('component', Object.assign({ name: 'app', selector: appRootSelector, flat: true, path: sourceDir, skipImport: true, project: options.name }, componentOptions)),
            (0, schematics_1.mergeWith)((0, schematics_1.apply)((0, schematics_1.url)('./other-files'), [
                ...
                componentOptions.inlineTemplate ? (0, schematics_1.filter)((path) => !path.endsWith('.html.template')) : (0, schematics_1.noop)(),
                componentOptions.skipTests ? (0, schematics_1.filter)((path) => !path.endsWith('.spec.ts.template')) : (0, schematics_1.noop)(),
                (0, schematics_1.applyTemplates)(Object.assign(Object.assign(Object.assign({ utils: core_1.strings }, options), { selector: appRootSelector }), componentOptions)),
