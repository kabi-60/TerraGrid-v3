...
class Filestore {
    ...
    getAllFolders() {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield new api_1.default(this.opts).get(`/baas/v1/project/${this.projectId}/folder`);
    ...
    uploadFile(folderId, fileStream) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield new api_1.default(this.opts).post(`/baas/v1/project/${this.projectId}/folder/${folderId}/file`, {
                formData: {
                    code: fileStream
                },
                json: false
