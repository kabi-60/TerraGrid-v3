...
class Datastore {
    ...
    getAllTables() {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield new api_1.default(this.opts).get(`/baas/v1/project/${this.projectId}/table`);
    ...
    getColumnDetails(tableId) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield new api_1.default(this.opts).get(`/baas/v1/project/${this.projectId}/table/${tableId}/column`);
            if (res.body && res.body.data) {
                return res.body.data;
            }
