...
exports.default = new command_1.default('token:list')
    ...
    const tokenArr = AUTH.list();
    const cliTable3 = (yield Promise.resolve().then(() => __importStar(require('../../cli_table')))).default;
    const listTable = new cliTable3();
    listTable.push([
        { hAlign: 'center', content: ansi_colors_1.yellow.bold('Token ID') },
        { hAlign: 'center', content: ansi_colors_1.yellow.bold('Token') },
        { hAlign: 'center', content: ansi_colors_1.yellow.bold('Created Time') }
    ]);
    listTable.push(...tokenArr);
    (0, logger_1.info)('\n' + listTable.toString());
}));
