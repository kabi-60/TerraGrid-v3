...
exports.default = new command_1.default('client:setup')
    ...
    yield config.save();
    (0, logger_1.message)((0, ansi_colors_1.bold)(constants_1.FILENAME.config) + ' file has been successfully created with client details.');
    (0, logger_1.info)();
    (0, logger_1.success)('Catalyst client setup complete!');
}));
